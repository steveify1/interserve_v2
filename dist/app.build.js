...
/*!******************************!*\
  !*** ./src/js/app.config.js ***!
  \******************************/
/*! exports provided: interServe */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "interServe", function() { return interServe; });
/*
* This is a website for a civil engineering company
*
*
*
*
*/
// Creating the namespace for our application
const interServe = window.interServe || {};



/***/ }),

/***/ "./src/js/components/quotation.js":
/*!****************************************!*\
  !*** ./src/js/components/quotation.js ***!
  \****************************************/
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _app_config_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./app.config.js */ "./src/js/app.config.js");
...
_app_config_js__WEBPACK_IMPORTED_MODULE_0__["interServe"].events = () => {
    ...
    const startApp = _ => {
        ...
        const activateMenuToggleOnHamburgerCllick = (_ => {
            _ui__WEBPACK_IMPORTED_MODULE_1__["ui"].getUIComp().staticComp.hamburgers.forEach(hamburger => {
                hamburger.addEventListener('click', _ => {
                    // toggle the hamburger
                    _ui__WEBPACK_IMPORTED_MODULE_1__["ui"].toggleHamburger(hamburger);
                    //toggle the main menu
                    _ui__WEBPACK_IMPORTED_MODULE_1__["ui"].toggleMenu(hamburger);
                });
            });
        ...
        _ui__WEBPACK_IMPORTED_MODULE_1__["ui"].initiateBannerSlider();
    ...
    return {
        ...
        init: () => {
            ...
            events.startPageSpecificEvents(_ui__WEBPACK_IMPORTED_MODULE_1__["ui"].getCurrentPage());
        ...
        onDOMContentLoaded: () => {
            ...
            document.addEventListener("DOMContentLoaded", () => {
                _app_config_js__WEBPACK_IMPORTED_MODULE_0__["interServe"].events().mutateNavOnScrollEvent();
        ...
        showQuotationEvent: () => {
            document.querySelectorAll(".show-quotation").forEach(btn => {
                btn.addEventListener("click", () => {
                    const modal = _ui__WEBPACK_IMPORTED_MODULE_1__["ui"].showQuotationForm(); // this function returns the modal object
        ...
        quotationFormSubmitEvent: (modal) => {
            document.querySelector("#quotation-form").addEventListener("submit", e => {
                ...
                Object(_utils_validator__WEBPACK_IMPORTED_MODULE_2__["validateQuotation"])(qs(`#${id} #name`), qs(`#${id} #email`), qs(`#${id} #phone`), qs(`#${id} #service`), qs(`#${id} #project-description`));
            });
        },
        ...
        mutateNavOnScrollEvent: () => {
            window.addEventListener("scroll", _ui__WEBPACK_IMPORTED_MODULE_1__["ui"].mutateNavOnScroll);
        },
        ...
        backToTopShowHideEvent: () => window.addEventListener("scroll", function () {
            _ui__WEBPACK_IMPORTED_MODULE_1__["ui"].showBackToTopButton()
        }),
         ...
         */
        toggleServices: () => {
            const serviceControls = _ui__WEBPACK_IMPORTED_MODULE_1__["ui"].getUIComp().staticComp.servicesPage.servicesControls;
            serviceControls.forEach(ctrl => {
                ctrl.addEventListener("click", _ui__WEBPACK_IMPORTED_MODULE_1__["ui"].setActiveService);
            })
        }
    }
};

const events = _app_config_js__WEBPACK_IMPORTED_MODULE_0__["interServe"].events();
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _event__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./event */ "./src/js/event.js");


/**
 * This here starts our application.
 */
_event__WEBPACK_IMPORTED_MODULE_0__["default"].init();
...
/* harmony import */ var _app_config_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./app.config.js */ "./src/js/app.config.js");
/* harmony import */ var _slider_js_slider__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../slider/js/slider */ "./src/slider/js/slider.js");
...
const lightbox = new _utils_lightbox__WEBPACK_IMPORTED_MODULE_2__["default"]({
    background: "black",
    zIndex: 2,
    closeOnClick: true,
});

_app_config_js__WEBPACK_IMPORTED_MODULE_0__["interServe"].ui = () => {
    const page = document.querySelector('input#page');
    

    console.log(typeof _components_quotation__WEBPACK_IMPORTED_MODULE_4__["default"], "hisd");
    ...
    return {
        ...
        insertNavIntoDOM: () => {
            ...
            <a href="./" id="logo">Interserve <br>construction
				</a>
        ...
        insertOnPageContactForm: () => {
            const html = `<!-- Contact us -->
				<h1 class="section-title">InterServe construction</h1>
        ...
        initiateBannerSlider: () => {
            ...
            if (document.querySelector(`#${banner ? banner.id : null} .iovon-slides`)) {
                const bannerSlider = new _slider_js_slider__WEBPACK_IMPORTED_MODULE_1__["default"](banner);
                bannerSlider.init({
                    interval: 6000,
                    showButtons: true,
                    indicators: true,
         ...
         */
        showQuotationForm: () => {
            const modal = new _utils_iovon_hybrid_modal__WEBPACK_IMPORTED_MODULE_3__["default"](_components_quotation__WEBPACK_IMPORTED_MODULE_4__["default"], []);
...
const ui = _app_config_js__WEBPACK_IMPORTED_MODULE_0__["interServe"].ui();

/***/ }),

/***/ "./src/js/utils/iovon-hybrid-modal.js":
/*!********************************************!*\
  !*** ./src/js/utils/iovon-hybrid-modal.js ***!
  \********************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _lightbox__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./lightbox */ "./src/js/utils/lightbox.js");
...
/* harmony default export */ __webpack_exports__["default"] = (IovonHybridModal);
...
/* harmony default export */ __webpack_exports__["default"] = (IovonAwesomeLightBox);
...
/*!***********************************!*\
  !*** ./src/js/utils/validator.js ***!
  \***********************************/
/*! exports provided: validateQuotation */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "validateQuotation", function() { return validateQuotation; });
//

const validateQuotation = (name, phone, email, service, msg) => {
    const fields = {
        name,
        phone,
        email,
...
/* harmony default export */ __webpack_exports__["default"] = (IovonAwesomeSlider);
